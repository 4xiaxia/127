...
export type IconName = 'microphone' | 'camera' | 'bag' | 'arrow-left' | 'logout' | 'location' | 'play' | 'pause' | 'chat-bubble' | 'book-open' | 'price-tag' | 'user' | 'academic-cap' | 'document-chart-bar' | 'view-dashboard' | 'clock' | 'map' | 'navigation' | 'plus' | 'check-circle' | 'upload' | 'clipboard' | 'x' | 'sun' | 'moon' | 'calendar' | 'bell' | 'chevron-down' | 'home' | 'download' | 'folder-open' | 'trash' | 'pencil-alt' | 'stop' | 'refresh';
