...
// Agent A - 前台交互服务实现
export class AgentA_Simple implements AgentA_FrontendService {
...
// Agent B - 智能工具服务实现
export class AgentB_Simple implements AgentB_IntelligentTools {
  role: 'TOOLS' = 'TOOLS';
...
// 全局实例
export const agentA = new AgentA_Simple();
export const agentB = new AgentB_Simple();
